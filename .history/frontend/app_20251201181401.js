/********************************************
 * TipTracker Frontend – FINAL FULL VERSION
 ********************************************/
...
if (registerForm) {
  registerForm.addEventListener("submit", async (e) => {
    ...
    } else alert(data.message || "Error during registration");
  });
}
...
/********************************************
 * PROFILE + EDIT PROFILE LOADER
 ********************************************/
if (
  getPage() === "profile.html" ||
  getPage() === "edit-profile.html"
) {
  ...
  async function loadProfile() {
    ...
    const data = await r.json();
    if (!r.ok || !data.user) return alert("Error loading profile");
