...
/********************************************
 * EDIT PROFILE PAGE – ONLY UPDATE HOURLY WAGE
 ********************************************/
if (getPage() === "edit-profile.html") {
  ...
  async function loadEditProfile() {
    ...
    // Show name + email as read-only text
  ...
  // Submit updated hourly wage
  form.addEventListener("submit", async (e) => {
    e.preventDefault();

    const newWage = document.getElementById("edit-wage").value;
    ...
    const r = await fetch(`${API_BASE}/auth/update`, {
      ...
      body: JSON.stringify({ hourlyWage: newWage }),
    });
    ...
    storedUser.hourlyWage = data.user.hourlyWage;
