...
/********************************************
 * PROFILE PAGE (Supports both pages)
 ********************************************/
if (
  ...
  async function loadProfile() {
    ...
    // Fill values ONLY if elements exist on the page
    const nameEl = document.getElementById("profile-name");
    const emailEl = document.getElementById("profile-email");
    const wageEl = document.getElementById("profile-wage");
    const editName = document.getElementById("edit-name");
    const editEmail = document.getElementById("edit-email");
    const editWage = document.getElementById("edit-wage");

    if (nameEl) nameEl.textContent = data.user.name;
    if (emailEl) emailEl.textContent = data.user.email;
    if (wageEl) wageEl.textContent = data.user.hourlyWage || "N/A";

    if (editName) editName.value = data.user.name;
    if (editEmail) editEmail.value = data.user.email;
    if (editWage) editWage.value = data.user.hourlyWage || "";
  }
