/************************************
 * TipTracker Frontend – Full Part 3 Release
 * Works with your existing backend exactly as uploaded
 ************************************/
  ...
  data.forEach((tip) => {
    ...
    card.innerHTML = `
      <div class="tip-main">
        ...
        <span class="tip-meta">${tip.restaurantName}</span><br>
...
// Auto-refresh tips when page loads
if (window.location.pathname.includes("tips.html")) {
  refreshTips();
}
